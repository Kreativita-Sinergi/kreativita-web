...
const paths: Record<string, React.ReactNode> = {
  globe: <path strokeLinecap="round" strokeLinejoin="round" d="M3 7h18M3 7v10a2 2 0 002 2h14a2 2 0 002-2V7M3 7l2-3h14l2 3" />,
  phone: (
    <>
  ...
  code: <path strokeLinecap="round" strokeLinejoin="round" d="M5 7l-2 5 2 5M19 7l2 5-2 5M14 4l-4 16" />,
  shield: <path strokeLinecap="round" strokeLinejoin="round" d="M12 3l8 4v5c0 5-3.5 8-8 9-4.5-1-8-4-8-9V7l8-4z" />,
  server: <path strokeLinecap="round" strokeLinejoin="round" d="M3 12a9 9 0 1018 0 9 9 0 00-18 0zm9-9v18m-9-9h18" />,
  bolt: <path strokeLinecap="round" strokeLinejoin="round" d="M13 2L3 14h7l-1 8 10-12h-7l1-8z" />,
};
