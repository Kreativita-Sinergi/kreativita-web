        ...
        <Reveal delay={200} className="relative">
          <div className="animate-float relative mx-auto max-w-md">
            ...
            <div className="absolute -inset-6 -z-10 opacity-60 blur-2xl" aria-hidden>
              ...
              <div className="absolute right-2 top-0 h-20 w-20 rounded-full bg-red-400/30" />
              <div className="absolute left-10 bottom-0 h-24 w-24 rounded-full bg-yellow-300/40" />
              <div className="absolute right-8 bottom-6 h-16 w-16 rounded-full bg-green-400/30" />
            </div>
